...
describe('address module', () => {
  test('create testnet address with payment credential', () => {
  ...
  test('create testnet address with payment & staking credential', () => {
    const expected =
  ...
  test('create mainnet address with payment credential', () => {
  ...
  test('create mainnet address with payment & staking credential', () => {
    const expected =
  ...
  test('test mainnet address encoding & decoding', () => {
    ...
    expect(actual.to_bech32()).toBe(expectedAddr);

    const actualEncoded = AddressBuilder.new().address(Address.from_bech32(expectedAddr)).build().encode().to_hex();
